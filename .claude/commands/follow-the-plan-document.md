...
Read that file and follow it to complete the task. If no path was given, look for an
`@`-mentioned plan document in the conversation, and if there is none, ask the user
which plan document to follow rather than guessing.
