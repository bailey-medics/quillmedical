  ...
  <MantineProvider defaultColorScheme="light">
    ...
    >
      ...
      <Text size="lg" ta="center">
        ...
        professional clinical letters—all with transparent billing and secure
        records using healthcare standards (FHIR and OpenEHR). Designed for
        fairness, privacy, and future-ready electronic patient records.
      </Text>
