...
export const demoMessages: Message[] = [
  ...
  },
  {
    id: "m2",
    senderId: "admin",
    senderName: "Gemma Corbett - Clinic Admin",
    givenName: "Gemma",
    familyName: "Corbett",
    gradientIndex: 10,
    text: "Thanks for your message — a clinician will triage this and we'll update Dr Corbett if needed.",
  ...
  },
  {
    ...
    familyName: "Corbett",
    gradientIndex: 10,
    text: "Triage note: ongoing abdominal pain post-consult, possible med query — please advise Dr Corbett.",
    timestamp: demoTimestamp(120_000),
  },
  {
    id: "m4",
    senderId: "doc",
    senderName: "Dr Gareth Corbett - Gastroenterology",
    givenName: "Gareth",
    familyName: "Corbett",
    gradientIndex: 5,
