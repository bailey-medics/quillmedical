...
2. Read all documentation in `/docs/docs/` (exclude `/docs/docs/llm/` and `/docs/docs/code/`)
3. Compare code vs documentation:
   - Code is the canonical truth
   - Update documentation in `/docs/docs/` to reflect actual implementation
   - If documentation describes features not in the code, leave it as-is (future features)
4. Any issues that you are unsure on how to resolve, ask the user to clarity in a numbered list.
