...
Login endpoint `/api/auth/login` has no rate limiting, failed login attempt tracking, or account lockout mechanisms, allowing unlimited brute force password attacks.

---

## Causes

1. No rate limiting middleware installed on login route
2. No failed login attempt counter per account
3. No account lockout after N failed attempts
4. No CAPTCHA or similar anti-automation protection
