...
New user accounts active by default
...
User model sets is_active=True by default, allowing newly registered accounts to immediately access system without email verification or admin approval.

---

## Causes

1. Column default is True in database schema
2. No email verification step in registration flow
3. No admin approval workflow before account activation
