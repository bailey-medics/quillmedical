...
- The user has highlighted some code. If no selection is present, ask the user what
  they want explained rather than guessing. You need to explain this to them in
  simple terms.
