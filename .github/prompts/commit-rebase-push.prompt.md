...
3. Check git status and confirm there are changes to commit4. Review the changes and create a clear, descriptive commit message following conventional commit format (e.g., "feat:", "fix:", "refactor:")
...
7. Push to current branch (do not create a new branch).
