...
Optional patient fields assumed present
...
Patient TypeScript type defines critical fields as optional (dob, age, sex, nationalNumber) but calling code may not handle undefined values safely, leading to runtime errors or missing data.

---

## Causes

1. TypeScript optional fields marked with `?` but no runtime checks
2. Destructuring without default values
3. String interpolation without null checks
