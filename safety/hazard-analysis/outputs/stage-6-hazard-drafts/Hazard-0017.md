...
Invalid letter content stored in EHRbase
...
create_letter_composition function does not validate letter content before submission to EHRbase including content length limits, markdown safety, or required field validation beyond type checking.

---

## Causes

1. No content length limits enforced
2. No validation of markdown safety (potential XSS if rendered unsafely)
3. No check for required fields beyond TypeScript/Pydantic type checking
4. Malicious or corrupted letter content accepted
